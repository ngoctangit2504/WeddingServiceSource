...
import { supplierSidebar } from "@/ultils/constant"
...
const SupplierSidebar = ({ dispatch }) => {
  ...
  return (
    <div className="w-full min-h-screen">
      <div className="py-12 pb-6 flex flex-col gap-1 justify-center items-center w-full">
        <span className="text-3xl text-pink-600 tracking-tight font-bold">
          SweetDreams.com
        </span>
        <small className="text-sm font-medium text-pink-500 ">
          Bảng Điều Khiển
        </small>
...
export default withBaseTopping(SupplierSidebar)
